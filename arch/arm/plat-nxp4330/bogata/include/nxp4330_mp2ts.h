#ifndef __NXP4330_TS_HEADER__
#define __NXP4330_TS_HEADER__
...
enum
{
    ...
    IOCTL_MPEGTS_GET_LOCK_STATUS    =   _IO(IOC_NX_MAGIC, 14),
    IOCTL_MPEGTS_DECRY_TEST         =   _IO(IOC_NX_MAGIC, 15),
    IOCTL_MPEGTS_ENCRY_TEST         =   _IO(IOC_NX_MAGIC, 16),
...
struct ts_config_descr {
	...
	union {
        unsigned char   data;
        struct {
        unsigned char   clock_pol   : 1;    /* Cpature 0, 1     */
        unsigned char   data_pol    : 1;    /* Cpature 0, 1     */
        unsigned char   sync_pol    : 1;    /* Cpature 0, 1     */
        unsigned char   err_pol     : 1;    /* Cpature 0, 1     */
