...
#define GTP_DEBUG1_ON         1  
#define GTP_DEBUG_ARRAY_ON    0
#define GT9XX_MULTITOUCH      0
//*************************** PART2:TODO define **********************************
...
#define GTP_RST_PORT    ((PAD_GPIO_B + 24))
#define GTP_INT_PORT    ((PAD_GPIO_B + 25) | PAD_FUNC_ALT0)
...
// for output pin
#define GTP_GPIO_GET_OUTPUT_VALUE(pin)  nxp_soc_gpio_get_out_value(pin)
...
#define GTP_I2C_NAME          "CTPM_ts"
#define GTP_FILE_DRIVER_NAME  "gt9xx_file"
...
#define GT9XX_ERROR_LEVEL	       KERN_ALERT
#define GT9XX_DEBUG_LEVEL	       KERN_INFO
#define GTP_DEBUG(fmt,arg...)          do{\
                                         if(GTP_DEBUG_ON)\
                                         printk("<<-GTP-DEBUG->> [%d]"fmt"\n",__LINE__, ##arg);\
                                       }while(0)
#define GTP_DEBUG1(fmt,arg...)          do{\
                                         if(GTP_DEBUG1_ON)\
                                         printk("<<-GTP-DEBUG->> [%d]"fmt"\n",__LINE__, ##arg);\
                                       }while(0)
